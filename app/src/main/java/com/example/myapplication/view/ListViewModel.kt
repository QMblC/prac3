...
import com.example.myapplication.state.MoviesListState
...
class ListViewModel(
    ...
    private val typesKey = stringSetPreferencesKey(MOVIE_KEY_TYPES)
    ...
    companion object {
        ...
        private const val MOVIE_KEY_TYPES = "MOVIE_TYPES"
    }
}